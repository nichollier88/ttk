...
char TEST_Instructions[] =
    "Lorem-ipsum-dolor-sit-amet,\nconsectetur-adipisicing-elit,\nsed-do-"
    "eiusmod-tempor-incididunt-ut-labore-et-dolore-magna-aliqua."
    "\n\nReallyreallyreallyreallyreallylonglonglonglonglongwordwordwordwordword"
    "wwwwwwwwwwwwwwwwwwwwwwthisthisthisthisthis "
    "mujunmdsvjsoidfhnvosfdnv.\n\nUt enim ad minim veniam,\nquis nostrud "
...
ttk_menu_item menu_music[] = {{"Artist 1", {0}, 0, 0},
                              {"Artist 2", {0}, 0, 0},
                              {"Artist 3", {0}, 0, 0},
                              {"Artist 4", {0}, 0, 0},
                              {"Artist 5", {0}, 0, 0},
                              ...
                              {"Artist 7", {0}, 0, 0},
                              {"Artist 8", {0}, 0, 0},
                              {"Some artist who has a really really, really "
                               "really, ultra-extremely long name",
                               {0},
                               TTK_MENU_ICON_SUB,
                               0},
                              {"Artist 9", {0}, 0, 0},
...
ttk_menu_item menu_extras[] = {{"Games", {0}, 0, 0},
                               {"Voice Memos", {0}, 0, 0},
                               {"and more!", {0}, 0, 0},
                               {0}};
...
int main(int argc, char** argv) {
    ttk_menu_item menu_settings[] = {
        ...
        {"Wheel Sensitivity",
         {ttk_mh_slider},
         TTK_MENU_ICON_SUB,
         ttk_md_slider(100, 1, 5, &wheel_sens)},
        {"and more!", {0}, 0, 0},
        {0}};
    ...
    ttk_menu_item menu[] = {
        {"Instructions",
         {ttk_mh_textarea},
         0,
         ttk_md_textarea(TEST_Instructions, 14)},
    ...
    menuwidget =
        ttk_new_menu_widget(menu, ttk_textfont, mainwindow->w, mainwindow->h);
