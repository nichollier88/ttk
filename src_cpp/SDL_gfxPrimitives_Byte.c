...
int fastPixelByteNolockNoclip(SDL_Surface* dst, Sint16 x, Sint16 y,
                              Uint32 color) {
    int bpp;
    Uint8* p;
...
int rectangleByte(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
                  Uint32 color) {
    int result;
...
int boxByte(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
            Uint32 color) {
    Sint16 left, right, top, bottom;
    Uint8 *pixel, *pixellast;
    int x, dx;
...
int lineByte(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
             Uint32 color) {
    int pixx, pixy;
    int x, y;
    int dx, dy;
...
int aalineByte(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
               Uint32 color) {
...
int filledCircleByte(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 r,
                     Uint32 color) {
    Sint16 left, right, top, bottom;
    int result;
    Sint16 x1, y1, x2, y2;
...
int ellipseByte(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry,
                Uint32 color) {
    Sint16 left, right, top, bottom;
    int result;
    Sint16 x1, y1, x2, y2;
...
int aaellipseByte(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry,
                  Uint32 color) {
    /*
     * Draw
     */
...
int filledEllipseByte(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rx,
...
int pieByte(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rad, Sint16 start,
            Sint16 end, Uint32 color) {
    fprintf(stderr, "Can't do pie on mono 'Pods\n");
    return 0;
}

int filledPieByte(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rad,
...
int trigonByte(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
...
int aatrigonByte(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
                 Sint16 x3, Sint16 y3, Uint32 color) {
    Sint16 vx[3];
    Sint16 vy[3];
...
int filledTrigonByte(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2,
...
int __polyByte(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
               Uint32 color, int connect_ends) {
    int result;
    int i;
    ...
    if (connect_ends) result |= lineByte(dst, *x1, *y1, *vx, *vy, color);

    return (result);
}

int polylineByte(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                 Uint32 color) {
    return __polyByte(dst, vx, vy, n, color, 0);
}

int polygonByte(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                Uint32 color) {
...
int aapolygonByte(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                  Uint32 color) {
    return __polyByte(dst, vx, vy, n, color, 1);
}

int aapolylineByte(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                   Uint32 color) {
    return __polyByte(dst, vx, vy, n, color, 0);
}
...
int filledPolygonByte(SDL_Surface* dst, const Sint16* vx, const Sint16* vy,
                      int n, Uint32 color) {
    int result;
    int i;
    int x, y, xa, xb;
