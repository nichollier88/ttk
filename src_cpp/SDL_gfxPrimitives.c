...
int fastPixelColorNolockNoclip(SDL_Surface* dst, Sint16 x, Sint16 y,
                               Uint32 color) {
    int bpp;
    Uint8* p;
...
int fastPixelRGBA(SDL_Surface* dst, Sint16 x, Sint16 y, Uint8 r, Uint8 g,
                  Uint8 b, Uint8 a) {
    Uint32 color;
...
int fastPixelRGBANolock(SDL_Surface* dst, Sint16 x, Sint16 y, Uint8 r, Uint8 g,
                        Uint8 b, Uint8 a) {
    Uint32 color;
...
int _putPixelAlpha(SDL_Surface* surface, Sint16 x, Sint16 y, Uint32 color,
                   Uint8 alpha) {
    ...
    if (x >= clip_xmin(surface) && x <= clip_xmax(surface) &&
        ...
        switch (surface->format->BytesPerPixel) {
            ...
            case 2: { /* Probably 15-bpp or 16-bpp */
                if (alpha == 255) {
                    *((Uint16*)surface->pixels + y * surface->pitch / 2 + x) =
                        color;
                } else {
                    Uint16* pixel =
                        (Uint16*)surface->pixels + y * surface->pitch / 2 + x;
...
int _filledRectAlpha(SDL_Surface* surface, Sint16 x1, Sint16 y1, Sint16 x2,
    ...
    switch (surface->format->BytesPerPixel) {
        ...
        case 2: { /* Probably 15-bpp or 16-bpp */
            Uint16 *row, *pixel;
            Uint32 dR = (color & Rmask), dG = (color & Gmask),
...
int filledRectAlpha(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2,
...
int pixelColorWeight(SDL_Surface* dst, Sint16 x, Sint16 y, Uint32 color,
                     Uint32 weight) {
    Uint32 a;
...
int pixelColorWeightNolock(SDL_Surface* dst, Sint16 x, Sint16 y, Uint32 color,
                           Uint32 weight) {
    Uint32 a;
...
int pixelRGBA(SDL_Surface* dst, Sint16 x, Sint16 y, Uint8 r, Uint8 g, Uint8 b,
              Uint8 a) {
    Uint32 color;
...
int hlineColorStore(SDL_Surface* dst, Sint16 x1, Sint16 x2, Sint16 y,
                    Uint32 color) {
...
int hlineRGBAStore(SDL_Surface* dst, Sint16 x1, Sint16 x2, Sint16 y, Uint8 r,
...
int hlineRGBA(SDL_Surface* dst, Sint16 x1, Sint16 x2, Sint16 y, Uint8 r,
              Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
...
int vlineRGBA(SDL_Surface* dst, Sint16 x, Sint16 y1, Sint16 y2, Uint8 r,
              Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
...
int rectangleColor(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
                   Uint32 color) {
    int result;
...
static int clipEncode(Sint16 x, Sint16 y, Sint16 left, Sint16 top, Sint16 right,
                      Sint16 bottom) {
    int code = 0;
...
static int clipLine(SDL_Surface* dst, Sint16* x1, Sint16* y1, Sint16* x2,
                    Sint16* y2) {
    Sint16 left, right, top, bottom;
    int code1, code2;
    int draw = 0;
...
int boxColor(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
             Uint32 color) {
    Sint16 left, right, top, bottom;
    Uint8 *pixel, *pixellast;
    int x, dx;
...
int aalineColorInt(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
...
int aalineColor(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
                Uint32 color) {
    return (aalineColorInt(dst, x1, y1, x2, y2, color, 1));
}

int aalineRGBA(SDL_Surface* dst, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2,
               Uint8 r, Uint8 g, Uint8 b, Uint8 a) {
...
int circleRGBA(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rad, Uint8 r,
               Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
...
int aacircleColor(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 r,
                  Uint32 color) {
    return (aaellipseColor(dst, x, y, r, r, color));
}

int aacircleRGBA(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rad, Uint8 r,
                 Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
...
int filledCircleColor(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 r,
                      Uint32 color) {
    Sint16 left, right, top, bottom;
    int result;
    Sint16 x1, y1, x2, y2;
...
int filledCircleRGBA(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rad, Uint8 r,
                     Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
...
int ellipseRGBA(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry,
                Uint8 r, Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
...
/* Based on code from Anders Lindstroem, based on code from SGE, based on code
 * from TwinLib */

int aaellipseColor(SDL_Surface* dst, Sint16 xc, Sint16 yc, Sint16 rx, Sint16 ry,
                   Uint32 color) {
    Sint16 left, right, top, bottom;
    Sint16 x1, y1, x2, y2;
    int i;
...
int aaellipseRGBA(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry,
                  Uint8 r, Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
...
int filledEllipseColor(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rx,
...
int filledEllipseRGBA(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rx,
...
int doPieColor(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rad, Sint16 start,
...
int pieColor(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rad, Sint16 start,
             Sint16 end, Uint32 color) {
    return (doPieColor(dst, x, y, rad, start, end, color, 0));
}

int pieRGBA(SDL_Surface* dst, Sint16 x, Sint16 y, Sint16 rad, Sint16 start,
...
int __polyColor(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                Uint32 color, int connect_last) {
    int result;
    int i;
    ...
    if (connect_last) result |= lineColor(dst, *x1, *y1, *vx, *vy, color);

    return (result);
}

int polygonColor(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                 Uint32 color) {
    return __polyColor(dst, vx, vy, n, color, 1);
}

int polylineColor(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                  Uint32 color) {
    return __polyColor(dst, vx, vy, n, color, 0);
}

int polygonRGBA(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                Uint8 r, Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
...
int polylineRGBA(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                 Uint8 r, Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
...
int __aapolyColor(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                  Uint32 color, int connect_last) {
    int result;
    int i;
    const Sint16 *x1, *y1, *x2, *y2;
...
int aapolygonColor(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                   Uint32 color) {
    return __aapolyColor(dst, vx, vy, n, color, 1);
}

int aapolylineColor(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                    Uint32 color) {
    return __aapolyColor(dst, vx, vy, n, color, 0);
}

int aapolygonRGBA(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                  Uint8 r, Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
...
int aapolylineRGBA(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                   Uint8 r, Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
    return (aapolylineColor(
        dst, vx, vy, n,
        ((Uint32)r << 24) | ((Uint32)g << 16) | ((Uint32)b << 8) | (Uint32)a));
}
...
int filledPolygonColor(SDL_Surface* dst, const Sint16* vx, const Sint16* vy,
                       int n, Uint32 color) {
    int result;
    int i;
    int x, y, xa, xb;
...
int filledPolygonRGBA(SDL_Surface* dst, const Sint16* vx, const Sint16* vy,
...
int characterColor(SDL_Surface* dst, Sint16 x, Sint16 y, char c, Uint32 color) {
    ...
    if (gfxPrimitivesFont[(unsigned char)c] == NULL) {
        gfxPrimitivesFont[(unsigned char)c] = SDL_CreateRGBSurface(
            SDL_SWSURFACE | SDL_HWSURFACE | SDL_SRCALPHA, charWidth, charHeight,
     ...
     */
    if ((gfxPrimitivesFontColor[(unsigned char)c] != color) ||
        (forced_redraw)) {
        /*
         * Redraw character
         */
...
int characterRGBA(SDL_Surface* dst, Sint16 x, Sint16 y, char c, Uint8 r,
                  Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
...
int stringColor(SDL_Surface* dst, Sint16 x, Sint16 y, const char* c,
                Uint32 color) {
    int result = 0;
    int curx = x;
...
int stringRGBA(SDL_Surface* dst, Sint16 x, Sint16 y, const char* c, Uint8 r,
               Uint8 g, Uint8 b, Uint8 a) {
    /*
     * Draw
     */
...
int bezierColor(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
                int s, Uint32 color) {
    int result;
    int i;
...
int bezierRGBA(SDL_Surface* dst, const Sint16* vx, const Sint16* vy, int n,
